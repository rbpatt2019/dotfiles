...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NLCK, KC_TRNS, KC_NO, KC_AMPR, KC_ASTR, KC_GRV, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_NO, KC_TRNS, KC_EQL, KC_DLR, KC_PERC, KC_CIRC, KC_PSLS, KC_TRNS, KC_TRNS, KC_COMM, KC_P4, KC_P5, KC_P6, KC_PPLS, KC_NO, KC_TRNS, KC_NO, KC_EXLM, KC_AT, LALT(KC_3), KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PDOT, KC_P1, KC_P2, KC_P3, KC_PENT, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0, KC_NO, KC_NO, KC_NO),
