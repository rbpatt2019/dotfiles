...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT(KC_NO, KC_BRID, KC_BRIU, KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, LGUI(KC_F), KC_END, KC_WH_D, KC_HOME, LCTL(KC_UP), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, LGUI(KC_SPC), KC_WH_L, KC_WH_U, KC_WH_R, LGUI(LALT(KC_SPC)), KC_LGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LCA(KC_LEFT), LGUI(KC_M), LGUI(LCTL(KC_F)), LCA(KC_RGHT), LCTL(KC_DOWN), LGUI(KC_Q), LGUI(KC_W), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_DEL, KC_ENT, LGUI(KC_C), LGUI(KC_V), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
};
